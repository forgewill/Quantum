module QMapHelper
  ...
  def average_points(root)
    ...
    #TODO Need to switch to new query syntax
    #if QResource.find(root).outgoing(:is_type).first != nil
    #  if QResource.find(root).outgoing(:is_type).first.title == 'Type_QParagraph'
